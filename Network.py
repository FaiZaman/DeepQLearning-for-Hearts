...
class DeepQNetwork(nn.Module):
    ...
    def __init__(self, learning_rate, n_actions):
        ...
        self.hidden_hidden_connected_layer_1 = nn.Linear(256, 416)
        self.hidden_hidden_connected_layer_2 = nn.Linear(416, 512)
        self.hidden_hidden_connected_layer_2 = nn.Linear(416, 512)
        self.hidden_output_connected_layer = nn.Linear(512, self.n_actions)
